...
def inception_v3_arg_scope(weight_decay = 0.00004, stddev = 0.1, batch_norm_var_colletion = 'moving_vars'):
	batch_norm_params = {
		'decay': 0.9997, 
		'epsilon': 0.001,
		...
		'variables_collections':{
			'beta': None,
			'gamma': None,
			'moving_mean': [batch_norm_var_colletion],
			'moving_variance': [batch_norm_var_colletion],
		}
	}
		...
		with slim.arg_scope([slim.conv2d, slim.max_pool2d, slim.avg_pool2d], stride = 1, padding = 'SAME'):
			with tf.variable_scope('Mixed_5b'):
				...
				with tf.variable_scope('Branch_3'):
					...
					branch_3 = slim.avg_pool2d(branch_3, 32, [1, 1], scope = 'Conv2d_0b_1x1')
			...
			with tf.variable_scope('Mixed_5c'):
				...
				with tf.variable_scope('Branch_3'):
					branch_3 = slim.avg_pool2d(net, [3, 3], scope = 'AvgPool_0a_3x3')
					branch_3 = slim.avg_pool2d(branch_3, 64, [1, 1], scope = 'Conv2d_0b_1x1')
				net = tf.concat([branch_0, branch_1, branch_2, branch_3], 3)
